...
def print_shop_details(): 
    ...
    name_count = 0 
    Label(frame, font='bold',text="Customer name").grid(column=0,row=1)
    Label(frame, font='bold',text="Receipt number").grid(column=0,row=2)
    Label(frame, font='bold',text="Number of items").grid(column=0,row=3) 
    Label(frame, font='bold',text="Items hired").grid(column=0,row=4)
    frame.grid(column =0, row = 7)

    while name_count < total_entries :
       Label(frame, text=name_count).grid(column=0,row=name_count+8) 
       Label(frame, text=(shop_details[name_count][0])).grid(column=7,row=name_count+8)
       Label(frame, text=(shop_details[name_count][1])).grid(column=7,row=name_count+8)
       Label(frame, text=(shop_details[name_count][2])).grid(column=7,row=name_count+8)
       Label(frame, text=(shop_details[name_count][3])).grid(column=7,row=name_count+8)
       name_count +=  1
...
#labels   
    ...
    entry_customer_name.bind("<FocusIn>")
    ...
    entry_receipt_number.bind("<FocusIn>")
    ...
    entry_items_quantity.bind("<FocusIn>")
    ...
    entry_items_hired = ttk.Combobox(main_window, textvariable=items_hired, values=('Books', 'Candy', 'Canned Food', 'Food', 'Car Parts', 'Chips', 'Clothing', 'Electronics', 'Food', 'Fruit', 'Hats', 'Instruments', 'Jewelry', 'Pets', 'Shoes', 'Furniture', 'Smartphones', 'Soda', 'Tablet', 'Toys', 'Video Games'), state='readonly')
